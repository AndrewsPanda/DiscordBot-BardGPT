            ...
            if not using:
                ...
                if user_id not in users_chatbot:
                    if await get_default_session_id() is None:
                        ...
                        await interaction.followup.send("> **[Click Here to Learn How to Set Cookies](https://docs.google.com/document/d/12N82-QlmWQVPLNswnE7w15WU8cb1YAOCYQuIyec5B3A/edit?usp=sharing)**")
                    else:
